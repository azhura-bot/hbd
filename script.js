...
new TypeIt("#teks1", {
  strings: [
    "Hari ini, saya langitkan semua doa terbaik saya untuk kamu Lithe Anjay.", 
    "Semoga hal-hal yang membuat kamu jatuh turut menjadi alasan kamu untuk tetap tumbuh ya gak?.", 
    "Semoga dunia senantiasa menjaga kamu dimanapun kamu berada, aamiin gitu jangan diem aja.", 
    "Semoga hari-hari kamu selalu diiringi cinta ibra yang tak pernah ada batasnya." , 
...
new TypeIt("#teks2", {
  strings: [
    "Terakhiran nih te",
    "Semoga atmosphere selalu membahagiakan kamu bagimanapun caranya.", 
    " ", 
    "barakallah fi umrik, Selamat Ulang Tahun Lithe yg keberapa sih gw lupa ehe.",
    "Intinya",
    " ",
